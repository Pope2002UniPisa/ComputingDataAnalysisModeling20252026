###############################################################
#   CLUSTER ANALYSIS                                          #
#   Author: Claudio Mazzi, SSSA Pisa                          #
###############################################################
...
library(psych)       # factor analysis (principal axis = pcf)
...
ps <- read_dta("/Users/claudiomazzi/Documents/PhD/ASM/2025_2026/Multivariate_analysis/DATA_PS.dta")
...
# ---------------------------------------------------------------------------
# 5. HIERARCHICAL CLUSTERING (WARD METHOD)
# ---------------------------------------------------------------------------
...
library(readr)
data_wdbc <- read.csv("/Users/claudiomazzi/Documents/PhD/PhD_Courses/SLLD_course/Exam/WDBC.csv")
head(data_wdbc)
...
# The analysis extracted five latent factors—attesa (waiting time), comfort, 
# assistenza  (communication and assistance), medici (doctor-related experience),
# and infermieri (nurse-related experience)—using principal axis 
# factor analysis. These factors summarize different dimensions 
# of patient experience in the Emergency Department.

# The hierarchical clustering performed using Ward’s method on the 
# factor scores suggested a clear three-cluster solution. The 
# dendrogram shows a well-separated structure, with three major 
# branches that justify the 3-group cut. 

# Cluster means for the five latent factors provide a meaningful 
# interpretation of the three clusters:

#   Cluster 1: (Moderately Negative Experience)
#   -------------------------------------------
#   This group shows slightly negative scores for comfort, 
#   communication/assistance, and the evaluations of doctors 
#   and nurses. Waiting-time perception (attesa) is around zero,
#   suggesting that time-related issues were not the primary 
#   driver of dissatisfaction. Overall, this cluster represents 
#   patients with somewhat below-average satisfaction, driven 
#   mainly by relational and communication aspects.

#   Cluster 2: (Highly Positive Experience)
#   ---------------------------------------
#   This group has consistently positive scores across all five 
#   dimensions. Patients in this cluster reported shorter perceived 
#   waiting times, better comfort conditions, clearer and more 
#   effective communication, and very positive evaluations of both 
#   doctors and nurses. This is the “best-experience” cluster and 
#   typically represents the most satisfied subgroup in the sample.

#   Cluster 3: (Strongly Negative Experience)
#   -----------------------------------------
#   This cluster shows systematically negative factor scores 
#   across all dimensions, with the lowest values for waiting 
#   time (attesa) and for the perceived quality of medical and 
#   nursing staff. This is the least satisfied group, characterized 
#   by negative perceptions of the overall service, communication, 
#   and relational aspects, as well as longer perceived waiting 
#   times. It likely represents patients who had markedly poor 
#   experiences in the Emergency Department.

# The k-means clustering on the same factor scores confirmed the 
# three-group solution, producing almost identical grouping 
# patterns. The visual separation in the k-means plot reinforces 
# the internal validity of the clusters identified by Ward’s 
# hierarchical method.

# Overall, the clustering identifies three meaningful profiles of 
# patient experience:
#   - a highly satisfied group (Cluster 2),
#   - a moderately dissatisfied group (Cluster 1),
#   - and a strongly dissatisfied group (Cluster 3).

# These results can be used to:
#   - characterize patient segments,
#   - examine associations with demographic or clinical variables,
#   - support targeted quality-improvement strategies,
#   - and reproduce Stata’s original analysis workflow in R.
